...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/snowy-lab-b0fa
```

A live public deployment of this template is available at [https://snowy-lab-b0fa.templates.workers.dev](https://snowy-lab-b0fa.templates.workers.dev)
